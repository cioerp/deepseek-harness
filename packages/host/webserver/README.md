...
- **Socket options stay minimal** — config selects the bind host, port, and the keep-alive timeout; backlog and other socket settings remain internal until a deployment needs them.
